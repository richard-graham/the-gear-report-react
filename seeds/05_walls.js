  ...
  return knex('walls').del()
    .then(function () {
      ...
      return knex('walls').insert([
        ...
        {island_name: 'North', region_name: 'Auckland', area_name: 'Coromandel', name: "Hold on to your face wall", crag_name: 'Castle Rock', access: 'Right along side of the Bete Noir Wall starting immediately right of the access gully, from left to right', },
      ]);
    });
};
